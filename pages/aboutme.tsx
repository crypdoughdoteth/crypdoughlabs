...
const aboutme: NextPage = () => {
    ...
    <div className="box-content shadow-lg pt-5 pb-5 pl-5 pr-5 max-h-screen-sm max-w-screen-sm font-medium indent-8 bg-white/30 text-base ">
        ...
        <p className="mt-2">
            ...
            vulnerabilities in their monetary policy, despite organizational and industry wide failures at risk management. In March 2022, I began my first venture with some incredible people I met through NFTs: The Crypto Cannabis Church. Only a few
